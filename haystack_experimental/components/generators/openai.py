...
from haystack_experimental.dataclasses import ChatMessage, ByteStream
...
class OpenAIGenerator:
    ...
    def run(
        ...
        prompt: str,
        system_prompt: Optional[str] = None,
         media: Optional[List[ByteStream]] = None,
        streaming_callback: Optional[Callable[[StreamingChunk], None]] = None,
        generation_kwargs: Optional[Dict[str, Any]] = None,
    ):
        """
        ...
        """
        if media:
            message = ChatMessage.from_user(prompt, media=media)
        else:
